...
$_['text_empty']        = 'Мы продолжаем добавлять товары на сайт. Переходи в <a href="https://vk.com/maturmarket" target="_blank">нашу группу</a>, чтобы следить за актуальными новостями.';
$_['text_quantity']     = 'Кол-во:';
$_['text_manufacturer'] = 'Магазин:';
