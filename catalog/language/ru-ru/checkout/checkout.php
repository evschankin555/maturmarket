...
$_['text_agree']                     = 'Я подтверждаю, что прочитал(-а) и согласен(-на) с <a href="%s" class="agree"><b>%s</b></a>';
$_['text_agree_page_name']           = 'Условиями соглашения';
$_['text_address_new']               = 'Я хочу использовать новый адрес';
$_['text_delivery_city']             = '<div class="selected-city-text">Вы оформляете доставку в городе <b>%s</b>. <div class="dev_selected_city selected-city-change">Сменить город</div></div>';
...
// Error
$_['error_warning']                  = 'Возникла проблема при обработке вашего заказа! Если проблема возникает повторно, попробуйте выбрать другой способ оплаты или <a href="%s">свяжитесь с администратором маркетплейса</a>.';
...
$_['error_approved']                 = 'Вы сможете войти после проверки учётной записи администрацией маркетплейса.';
...
$_['error_agree']                    = 'Вы должны прочитать и согласится с документом %s!';
...
$_['error_shipment_date']            = 'Укажите дату доставки!';