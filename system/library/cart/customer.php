...
class Customer {
  ...
  public function login($email, $password, $override = false) {
	...
	public function isMaster() {
		...
		$query = $this->db->query("SELECT count(*) AS count FROM " . DB_PREFIX . "customer_group_description cgd inner join " . DB_PREFIX . "customer cus on cgd.customer_group_id = cus.customer_group_id WHERE cus.customer_id = '" . (int)$this->customer_id . "' and cgd.name='" . $MASTER_CUSTOMER_GROUP_NAME . "'");
