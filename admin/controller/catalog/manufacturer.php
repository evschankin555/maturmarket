...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['category_matchings'])) {
			$data['category_matchings'] = $this->request->post['category_matchings'];
		} elseif (isset($this->request->get['manufacturer_id'])) {
			$category_matching_list = $this->model_catalog_category->getCategoryMathingsByManufacturer($this->request->get['manufacturer_id']);
			foreach ($category_matching_list as &$item) {
				$item['import_name'] = htmlentities($item['import_name']);
			}
			$data['category_matchings'] = $category_matching_list;
		} else {
			$data['category_matchings'] = array();
		}		
