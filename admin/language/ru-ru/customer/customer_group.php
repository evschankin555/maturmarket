...
$_['error_default']      = 'Эту группу покупателей нельзя удалить, поскольку она назначена для основного маркетплейса!';
$_['error_store']        = 'Эту группу покупателей нельзя удалить, поскольку она используется в %s маркетплейсах!';
