...
$_['text_list']                        = 'Список маркетплейсов';
$_['text_add']                         = 'Добавить';
...
$_['column_url']	                   = 'URL маркетплейса';
$_['column_action']                    = 'Действие';

// Entry
$_['entry_url']                        = 'URL маркетплейса';
$_['entry_ssl']                        = 'SSL URL';
...
// Help
$_['help_url']                         = 'Включая полный URL к маркетплейсу. Добавьте \'/\' в конце. Например: http://wwww.yourdomain.com/path/ не используйте в качестве адреса директорию основного маркетплейса используйте новый домен или суб домен.';
$_['help_ssl']                         = 'Включая полный URL к маркетплейсу. Добавьте \'/\' в конце. Например: http://wwww.yourdomain.com/path/ не используйте в качестве адреса директорию основного маркетплейса используйте новый домен или суб домен.';
$_['help_geocode']                     = 'Укажите geocode расположение вашего маркетплейса.';
$_['help_open']                        = 'Укажите время работы маркетплейса.';
...
$_['help_tax_default']                 = 'Использовать адрес маркетплейса для подсчета налогов для покупателей без авторизации. Вы можете выбрать его в качестве адреса доставки покупателям или как адрес оплаты.';
...
$_['error_url']                        = 'Необходим URL маркетплейса!';
...
$_['error_default']                    = 'Нельзя удалить Основной маркетплейс!';
$_['error_store']                      = 'Этот маркетплейс нельзя удалить, поскольку он назначен к %s заказам!';