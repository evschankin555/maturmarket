...
$_['entry_owner']                      = 'Владелец маркетплейса';
...
$_['entry_city']                       = 'Город по-умолчанию';
...
$_['entry_tax_default']                = 'Налоговый адрес маркетплейса';
...
$_['entry_image_location']             = 'Размер изображения маркетплейса';
...
$_['entry_ftp_root']                   = 'FTP Директория маркетплейса';
...
$_['entry_noindex_status']	           = 'Использовать noindex для категорий, магазинов, товаров, статей и т д';
$_['entry_noindex_disallow_params']	   = 'Игнорировать noindex для страниц с get параметрами:';

// Help
$_['help_geocode']                     = 'Пожалуйста, укажите geocode расположение вашего маркетплейса.';
$_['help_open']                        = 'Заполните время работы маркетплейса.';
...
$_['help_location']                    = 'Местоположения маркетплейсов, которые вы хотите отображать на странице с формой обратной связи.';
$_['help_city']                        = 'Этот город будет показан посетителю, если он еще не выбирал никакого города, а его местоположение не позволяет определить город или его города нет в списке доступных на сервисе';
...
$_['help_product_count']               = 'Показывать количество товаров в категории. Включение этой опции может привести к увеличению времени загрузки страниц для маркетплейсов с большим количеством товаров!</b>';
...
$_['help_review_mail']                 = 'Отправить E-Mail владельцу маркетплейса при создании нового отзыва.';
...
$_['help_tax_default']                 = 'Если пользователь не залогинен, использовать адрес маркетплейса для вычисления налогов. Вы можете выбрать использование адреса маркетплейса либо в качестве адреса доставки, либо платежного адреса покупателя.';
...
$_['help_account_mail']                = 'Оповестить владельца маркетплейса о регистрации нового покупателя.';
...
$_['help_processing_status']           = 'Установите статус заказа покупателя, которого заказ должен достигнуть, прежде чем на складе будет сокращено наличие и у покупателя будут применены бонусы и скидки по промокоду.';
...
$_['help_fraud_status']                = 'Этот статус заказа используется, когда клиент подозревается в попытке изменить платежные реквизиты заказа или использовать промокод, подарочный ваучер, баллы, которые уже были использованы.';
$_['help_order_mail']                  = 'Отправить E-Mail владельцу маркетплейса при получении нового заказа.';
...
$_['help_affiliate_mail']              = 'Уведомлять на E-Mail владельца маркетплейса о регистрации нового партнера.';
...
$_['help_seo_url']                     = 'Необходимо настроить файл .htaccess в корневом каталоге маркетплейса (переименуйте .htaccess.тхт в .htaccess)';
...
$_['help_maintenance']                 = 'Отключает отображение маркетплейса покупателям. Им будет отображаться сообщение об обслуживании. После авторизации админом, маркетплейс будет полноценно отображаться.';
...
$_['error_owner']                      = 'Имя владельца маркетплейса должно содержать от 3 до 64 символов!';
$_['error_address']                    = 'Адрес маркетплейса должен содержать от 10 до 256 символов!';
...
$_['error_image_location']             = 'Необходимо установить размер изображения маркетплейса!';
