...
$_['text_enter_category']  	 = 'Выберите категорию';
...
$_['entry_import_name']      = 'Название в файле';
...
$_['tab_design']             = 'Дизайн';
$_['tab_category_matching']  = 'Категории импорта';
$_['entry_type']        	 = 'Тип';
...
$_['error_product']      	 = 'Этот магазин нельзя удалить так как он используется в %s товарах!';
