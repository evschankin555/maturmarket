...
$_['text_sku']        	     = 'Артикул (SKU, код магазина) - sku';
$_['text_upc']        	     = 'UPC - upc';
$_['text_ean']        	     = 'EAN - ean';
$_['text_jan']        	     = 'JAN - jan';
...
$_['entry_shopname']         = 'Название маркетплейса';
...
$_['help_shopname']          = 'Короткое название маркетплейса (название, которое выводится в списке найденных на Яндекс.Маркете товаров. Не должно содержать более 20 символов).';
$_['help_company']           = 'Полное наименование компании, владеющей маркетплейсом. Не публикуется, используется для внутренней идентификации.';
...
$_['help_vendorcode']        = 'По-умолчанию артикул (SKU, код магазина).';
...
$_['help_manufacturer']      = 'Отметьте магазины из которых надо экспортировать предложения для Яндекс.Маркета. Если не отмечено, то выгружается весь товар.';
