...
// Entry
$_['entry_shop_id']               = 'Идентификатор (номер кассы) маркетплейса';
$_['entry_sign']                  = 'Секретный ключ маркетплейса';
...
$_['error_shop_id']         = 'Поле "Идентификатор (номер кассы) маркетплейса" должно быть заполнено!';
$_['error_sign']            = 'Поле "Секретный ключ маркетплейса" должно быть заполнено!';
?>