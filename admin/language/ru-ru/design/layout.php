...
$_['text_route']          = 'Выберите маркетплейсы и роуты, которые будут использоваться с этим макетом';
...
$_['error_default']       = 'Этот макет нельзя удалить, поскольку он используется в маркетплейсе по умолчанию!';
$_['error_store']         = 'Этот макет нельзя удалить, поскольку он используется в %s маркетплейсах!';
...
$_['error_manufacturer']  = 'Этот макет нельзя удалить, поскольку он используется в %s магазинах!';
