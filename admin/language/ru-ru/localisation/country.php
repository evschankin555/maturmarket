...
$_['error_default']           = 'Эту страну нельзя удалить, поскольку она используется как страна по умолчанию для маркетплейса!';
$_['error_store']             = 'Эту страну нельзя удалить, поскольку она используется в %s маркетплейсах!';
