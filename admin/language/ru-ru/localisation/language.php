...
$_['help_status']       = 'Показывать/Скрывать в переключателе языков витрины маркетплейса';
...
$_['error_store']       = 'Этот Язык нельзя удалить, поскольку он используется в %s маркетплейсах!';
