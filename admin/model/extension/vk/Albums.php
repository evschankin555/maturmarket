...
class Albums
{
    ...
    public function set($data) {
        $this->db->query("INSERT INTO " . DB_PREFIX . "vk_albums SET " . DB_PREFIX . "id = '" . $data[DB_PREFIX . 'id'] . "', " . DB_PREFIX . "parent_id = '" . $data[DB_PREFIX . 'parent_id'] . "', vk_title = '" . $this->db->escape($data['vk_title']) . "', vk_id = '" . (int)$data['vk_id'] . "', date_added = NOW(), date_modified = NOW()");
    }
