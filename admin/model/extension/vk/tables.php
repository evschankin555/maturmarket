...
class ModelExtensionVkTables extends Model
{
    ...
    public function createTables()
    {
        ...
        $this->db->query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "vk_albums (" . DB_PREFIX . "id INT(11), " . DB_PREFIX . "parent_id INT(11), " . DB_PREFIX . "vk_title VARCHAR(255), vk_id INT(11), `date_added` datetime NOT NULL, `date_modified` datetime NOT NULL)");
