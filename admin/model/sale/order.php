...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'readiness'           	  => $order_query->row['readiness']
			);
		} else {
			return;
		}
	...
	public function changeReadiness($order_id, $changeTo) {
		$order_info = $this->getOrder($order_id);
		...
		if ($order_info) {
			...
			$this->db->query("UPDATE `" . DB_PREFIX . "order` SET readiness = '" . (int)$changeTo . "' WHERE order_id = '" . (int)$order_id . "'");
