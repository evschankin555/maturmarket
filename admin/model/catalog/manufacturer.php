...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		if (isset($data['category_matchings'])) {
			foreach ($data['category_matchings'] as $matching) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "category_matching_for_import SET manufacturer_id = '" . (int)$manufacturer_id . "', category_id = '" . (int)$matching['category_id'] . "', import_name = '" . $this->db->escape($matching['import_name']) . "'");
			}
		}
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		$this->db->query("DELETE FROM `" . DB_PREFIX . "category_matching_for_import` WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");

		if (isset($data['category_matchings'])) {
			foreach ($data['category_matchings'] as $matching) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "category_matching_for_import SET manufacturer_id = '" . (int)$manufacturer_id . "', category_id = '" . (int)$matching['category_id'] . "', import_name = '" . $this->db->escape(html_entity_decode($matching['import_name'])) . "'");
			}
		}
